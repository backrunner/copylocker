...
problem; it does not become a licensing incident. See the [Runbook](../operations/runbook).
...
risk list is in the [Threat Model](../security/threat-model#residual-risks) and in
...
are demos and cheap tools only. See [Protection Levels](./protection-levels).
...
[Runbook](../operations/runbook#root-key-compromise). This is why Root keys are generated and
kept offline.
...
[go-live checklist](./protection-levels#go-live-checklist) exists because of this question.

**What does it cost to run?**
The design target is under $20/month at 100,000 active devices validating daily
(NFR-COST-001). The [cost model](../operations/cost-estimation) gives the formulas.
