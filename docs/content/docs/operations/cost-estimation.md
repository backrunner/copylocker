...
<p class="cl-callout-title">Prices move</p>
<p>All unit prices below are placeholders from public Cloudflare pricing at the time of writing — <strong>verify against Cloudflare's then-current pricing</strong> before budgeting. The formulas are the durable part; plug in current rates.</p>
</aside>
