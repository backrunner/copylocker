...
navTitle: The Licensing Model
order: 4
description: CopyLocker policies are built from five orthogonal axes — entitlement, validity, version scope, seats, and mode — combined, not enumerated.
---
