...
navTitle: 5-Minute Quickstart
order: 2
description: Provision a Cloudflare backend, initialize it with the CLI, issue one license, and unseal one asset from a web app — in five minutes.
---
...
<p class="cl-callout-title">Before you start</p>
<p>Nothing is on a public registry yet. The CLI is built from this repository, and the SDK packages are consumed from the workspace or local tarballs. See <a href="https://github.com/backrunner/copylocker">repository state</a> — no npm package has been published and no hosted CopyLocker service exists.</p>
</aside>
...
- [Protection Levels](/docs/guide/protection-levels) — what to seal, and the go-live checklist.
- [The Licensing Model](/docs/guide/licensing-model) — trials, subscriptions, dunning, perpetual fallback.
- [Deployment](/docs/guide/deployment) — migrations discipline, secrets, Cron, and queues.
- [Runbook](/docs/operations/runbook) — when something goes wrong.
