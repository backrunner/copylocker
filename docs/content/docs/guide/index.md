---
title: What is CopyLocker
navTitle: What is CopyLocker
order: 1
description: CopyLocker is a licensing and anti-tamper toolkit for software vendors — a self-hosted licensing server plus client SDKs built on productive verification.
---
...
`unseal()` either returns plaintext or throws. The [Protection Levels](/docs/guide/protection-levels) guide
...
down in the [Security & Threat Model](/docs/security/threat-model) — read it before you ship.
...
- [5-Minute Quickstart](/docs/guide/quickstart) — server up, license issued, first `unseal()`.
- [Protection Levels (L0–L4)](/docs/guide/protection-levels) — how to actually use the SDK.
- [The Licensing Model](/docs/guide/licensing-model) — the five-axis policy system.
- [Deployment](/docs/guide/deployment) and [Operations](/docs/operations/runbook) — running it in production.
