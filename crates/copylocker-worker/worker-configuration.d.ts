/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4c9ffdc09a93cf2cfd472572e1d9bf9e)
...
interface __BaseEnv_Env {
	...
	DB: D1Database;
	EVENTS: Queue;
	EPOCH_SIGNING_KEY: SecretsStoreSecret;
	EPOCH_FAST_SIGNING_KEY: SecretsStoreSecret;
	SERVER_PEPPER: SecretsStoreSecret;
	ADMIN_TOKEN_PEPPER: SecretsStoreSecret;
	VARIANT_PARAMS_KEY: SecretsStoreSecret;
	ASSET_KEK_KEY: SecretsStoreSecret;
	BUILD_SIGNING_KEY: SecretsStoreSecret;
	STRIPE_WEBHOOK_SECRET: SecretsStoreSecret;
	PADDLE_WEBHOOK_SECRET: SecretsStoreSecret;
	LEMONSQUEEZY_WEBHOOK_SECRET: SecretsStoreSecret;
	ENVIRONMENT: "development";
	LICENSE: DurableObjectNamespace /* LicenseDO */;
	ACCOUNT: DurableObjectNamespace /* AccountDO */;
	ISSUER: DurableObjectNamespace /* IssuerDO */;
	ADMIN_AUDIT: DurableObjectNamespace /* AdminAuditDO */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./build/worker/shim");
		durableNamespaces: "LicenseDO" | "AccountDO" | "IssuerDO" | "AdminAuditDO";
	}
